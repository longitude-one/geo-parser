...
class LexerTest extends TestCase
{
    ...
    public static function dataProvider(): \Generator
    {
        ...
        yield ['1e-5', [new Token('1e-5', Lexer::T_FLOAT, 0)]]; // 1e-5 is 0.00001
        yield ['0.00003', [new Token('0.00003', Lexer::T_FLOAT, 0)]]; // 1e-5 is 0.00001
        yield ['0.00000003', [new Token('0.00000003', Lexer::T_FLOAT, 0)]]; // 1e-5 is 0.00001
        yield ['40° 26\' 46" N', [
