...
class ParserCharacterizationTest extends TestCase
{
    ...
    public static function dataSourceInvalidCoordinates(): \Generator
    {
        yield 'explicit sign with cardinal direction' => [
            ...
            '[Syntax Error] line 0, col 4: Error: Expected LongitudeOne\\Geo\\String\\Lexer::T_INTEGER or LongitudeOne\\Geo\\String\\Lexer::T_FLOAT, got "S" in value "-40 S"',
        ];
        yield 'unexpected sign after cardinal' => [
            '40°N +45°W',
            UnexpectedValueException::class,
            '[Syntax Error] line 0, col 6: Error: Expected LongitudeOne\Geo\String\Lexer::T_INTEGER or LongitudeOne\Geo\String\Lexer::T_FLOAT, got "+" in value "40°N +45°W"',
        ];
