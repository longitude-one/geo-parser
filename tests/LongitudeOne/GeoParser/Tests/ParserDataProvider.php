...
final class ParserDataProvider
{
    ...
    public static function dataSourceBad(): \Generator
    {
        ...
        yield ['40°, 45', UnexpectedValueException::class, '[Syntax Error] line 0, col -1: Error: Expected LongitudeOne\GeoParser\Lexer::T_DEGREE, got end of string. in value "40°, 45"'];
        ...
        yield ['55:34:22°', UnexpectedValueException::class, '[Syntax Error] line 0, col 8: Error: Expected LongitudeOne\GeoParser\Lexer::T_INTEGER or LongitudeOne\GeoParser\Lexer::T_FLOAT, got "°" in value "55:34:22°"'];
        yield ['55:34.22', UnexpectedValueException::class, '[Syntax Error] line 0, col 3: Error: Expected LongitudeOne\GeoParser\Lexer::T_INTEGER, got "34.22" in value "55:34.22"'];
        yield ['55#34.22', UnexpectedValueException::class, '[Syntax Error] line 0, col 2: Error: Expected LongitudeOne\GeoParser\Lexer::T_INTEGER or LongitudeOne\GeoParser\Lexer::T_FLOAT, got "#" in value "55#34.22"'];
